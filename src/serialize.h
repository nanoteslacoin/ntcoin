...
// Basic types
//
#define WRInTcoinATA(s, obj)   s.write((char*)&(obj), sizeof(obj))
...
template<typename Stream> inline void Serialize(Stream& s, char a,           int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, signed char a,    int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, unsigned char a,  int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, signed short a,   int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, unsigned short a, int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, signed int a,     int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, unsigned int a,   int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, signed long a,    int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, unsigned long a,  int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, int64 a,          int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, uint64 a,         int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, float a,          int, int=0) { WRInTcoinATA(s, a); }
template<typename Stream> inline void Serialize(Stream& s, double a,         int, int=0) { WRInTcoinATA(s, a); }
...
template<typename Stream> inline void Serialize(Stream& s, bool a, int, int=0)    { char f=a; WRInTcoinATA(s, f); }
