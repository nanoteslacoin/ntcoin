...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 1000 ;	// stake age of full weight: 10 y
unsigned int nStakeTargetSpacing = 60 * 2;			// 60 sec block spacing
 
int64 nChainStartTime = 1481990835;
...
const string strMessageMagic = "nTcoin Signed Message 2016:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = 0.0 * MAX_MINT_PROOF_OF_STAKE; 
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NanoTeslaCoin
    bool fStrictPayToScriptHash = true; // Always active in NanoTeslaCoin
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    printf("ProcessBlock: ACCEPnTcoin\n");
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NanoTeslaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "nTcoin TO MOON and SUN, BY STORM KNIGHT";
        CTransaction txNew;
	...
	if (true  && (block.GetHash() != hashGenesisBlock)) 
	{
        ...
        assert(block.hashMerkleRoot == uint256("0x659f09967709053e6d749a19e86fdb11efe6ff21ec12fefdb92d48499417211e"));
