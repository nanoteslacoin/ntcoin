...
public:
    ...
    void updateEntry(const QString &address, const QString &label, bool isMine, int status)
    {
        ...
        case CT_UPDAnTcoin:
            if(!inModel)
            {
                OutputDebugStringF("Warning: AddressTablePriv::updateEntry: Got CT_UPDAnTcoin, but entry is not in model\n");
                break;
            }
        ...
        case CT_DELEnTcoin:
            if(!inModel)
            {
                OutputDebugStringF("Warning: AddressTablePriv::updateEntry: Got CT_DELEnTcoin, but entry is not in model\n");
                break;
            }
