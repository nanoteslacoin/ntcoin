        ...
        BOOST_FOREACH(const CTxIn& txin, tx.vin)
        {
            ...
            if (mi != mapWallet.end())
            {
                ...
                else if (!wtx.IsSpent(txin.prevout.n) && IsMine(wtx.vout[txin.prevout.n]))
                {
                    ...
                    wtx.WriteToDisk();
                    NotifyTransactionChanged(this, txin.prevout.hash, CT_UPDAnTcoin);
                }
            }
        }
    }
...
bool CWallet::AddToWallet(const CWalletTx& wtxIn)
{
    uint256 hash = wtxIn.GetHash();
    {
        ...
        NotifyTransactionChanged(this, hash, fInsertedNew ? CT_NEW : CT_UPDAnTcoin);
...
{
    {
        ...
        printf("CommitTransaction:\n%s", wtxNew.ToString().c_str());
        {
            ...
            BOOST_FOREACH(const CTxIn& txin, wtxNew.vin)
            {
                ...
                coin.WriteToDisk();
                NotifyTransactionChanged(this, coin.GetHash(), CT_UPDAnTcoin);
            }
...
bool CWallet::SetAddressBookName(const CTxDestination& address, const string& strName)
{
    ...
    NotifyAddressBookChanged(this, address, strName, ::IsMine(*this, address), (mi == mapAddressBook.end()) ? CT_NEW : CT_UPDAnTcoin);
    if (!fFileBacked)
        return false;
...
bool CWallet::DelAddressBookName(const CTxDestination& address)
{
    ...
    NotifyAddressBookChanged(this, address, "", ::IsMine(*this, address), CT_DELEnTcoin);
    if (!fFileBacked)
        return false;
...
{
    {
        ...
        if (mi != mapWallet.end())
            NotifyTransactionChanged(this, hashTx, CT_UPDAnTcoin);
    }
}
